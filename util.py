...
for x1, y1, x2, y2 in [
    (-CORNER_MEET, HALF_WID, CORNER_MEET, HALF_WID),
    (CORNER_MEET, -HALF_WID, -CORNER_MEET, -HALF_WID),
    ...
    (GOAL_BACK, -GOAL_HALF, HALF_LEN, -GOAL_HALF),
    (HALF_LEN, GOAL_HALF, GOAL_BACK, GOAL_HALF),
    (CORNER_MEET, HALF_WID, CORNER_MEET, HALF_WID - CORNER_BEVEL),
    (-CORNER_MEET, HALF_WID - CORNER_BEVEL, -CORNER_MEET, HALF_WID),
    (CORNER_MEET, -HALF_WID + CORNER_BEVEL, CORNER_MEET, -HALF_WID),
    (-CORNER_MEET, -HALF_WID, -CORNER_MEET, -HALF_WID + CORNER_BEVEL),
]:
